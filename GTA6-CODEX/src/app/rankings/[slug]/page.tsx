      ...
      <div className="container-max relative">
        <Reveal className="mb-10">
          <nav className="mb-4 text-sm text-auto-text-secondary" aria-label="Breadcrumb">
            ...
            <span className="mx-2">/</span>
            <span className="text-auto-text">{ranking.def.shortTitle}</span>
          </nav>

          <h1 className="text-4xl font-bold text-auto-text">{ranking.def.title}</h1>
          <p className="mt-3 max-w-3xl text-auto-text-secondary">{ranking.def.intro}</p>
          <p className="mt-2 text-sm text-auto-text-tertiary">
