/**
 * Skyline builder for the GTA6 Codex WebGL engine.
 * Creates the Miami skyline with buildings, windows, and palm trees.
 */
...
export interface SkylineBuilderOptions {
  farGroup: THREE.Group
  quality: QualityProfile
  fog: THREE.FogExp2
}

export function buildFarSkyline(options: SkylineBuilderOptions): { updater: Updater; windowUpdaters: Updater[] } {
  const { farGroup, quality, fog } = options
