 ...
 *
 * Nota: la CSP de next.config.js también necesita permitir el dominio de
 * AdSense en `script-src` para que el script llegue a cargar una vez que
 * el consentimiento esté resuelto — ver el comentario en next.config.js.
 *
 ...
 */
export function ConsentBanner({ gaId, adsenseClientId }: { gaId?: string; adsenseClientId?: string }) {
