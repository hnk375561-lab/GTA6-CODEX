      ...
      {items.map(({ vehicle, powerDiff }) => (
        <li key={vehicle.slug}>
          <Link
            ...
            className="group flex items-center gap-3 rounded-md border border-dashed border-transparent px-2 py-2 -mx-2 transition-colors duration-200 hover:border-auto-border-strong hover:bg-auto-darker/40"
          >
            <EntityImage
              entity={vehicle}
            ...
            <div className="flex min-w-0 flex-col gap-1">
              ...
              <span className="truncate text-xs text-auto-text-secondary">
