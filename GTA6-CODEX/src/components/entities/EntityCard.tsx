    ...
    >
      ...
      <Card hoverable className={cn('flex h-full flex-col overflow-hidden !p-0', size === 'hero' && 'lg:flex-row')}>
          ...
          {rankBadge && (
            ...
            <span className="absolute right-3 top-3 z-10 inline-flex items-center gap-1.5 rounded-full border border-auto-border-strong bg-auto-darker/90 px-2.5 py-1 font-mono text-[11px] font-semibold text-auto-accent-strong backdrop-blur-sm">
        ...
        >
          ...
          <h2
            className={cn(
              'font-bold text-auto-text transition-colors group-hover:text-auto-accent',
          ...
          <div className={cn('mt-auto flex items-center justify-between gap-2 border-t border-auto-border', size === 'compact' ? 'pt-2' : 'pt-3')}>
