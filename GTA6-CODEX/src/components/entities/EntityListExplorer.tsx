        ...
        {classGroupOptions.length > 0 && (
          <>
            ...
            {classGroupOptions.map(({ group, count }) => (
              ...
              >
                {group}
                <span className="ml-1.5 text-auto-text-secondary/80">{count}</span>
              </button>
            ))}
          </>
        )}
          ...
          <>
            ...
            <div className="flex items-center gap-1.5">
              <input
                ...
                className="w-20 rounded-lg border border-auto-border bg-auto-card/60 px-2 py-1 text-[11px] font-semibold text-auto-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-auto-accent"
              />
              <span className="text-[11px] text-auto-text-tertiary">–</span>
              <input
                type="number"
