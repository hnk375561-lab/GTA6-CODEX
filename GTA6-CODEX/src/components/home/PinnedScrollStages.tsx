 ...
 *
 * Subido de 170 a 210 (pedido explícito: "que el scroll sea más
 * duradero", con foco en el panel del hero). Es una única constante
 * compartida por los 5 paneles del track — hoy `PinnedScrollStages` no
 * soporta una duración distinta por panel, así que estirar solo el hero
 * sin tocar el resto requeriría un cambio de diseño más grande (longitud
 * de scroll por-stage en vez de global). Se deja documentado acá para
 * quien quiera esa versión más adelante. */
const STAGE_SCROLL_VH = 210
