...
export function MagicCard(props: MagicCardProps) {
  ...
  const isDarkTheme = useMemo(() => {
    return true // GTA6 siempre es dark
  }, [])
  ...
  return (
    <motion.div
      className={cn(
        'group relative isolate overflow-hidden rounded-lg border border-gta-border',
        className
      )}
    ...
    >
      <div className="bg-gta-card absolute inset-px z-20 rounded-lg" />
