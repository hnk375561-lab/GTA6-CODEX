...
import { ScrollSnapCatch } from '@/components/home/ScrollSnapCatch'
...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Capítulo 5.1: transición "splash" hero → categorías. Zona de
          captura corta, nunca activa en listados/fichas (ver
          ScrollSnapCatch.tsx) — se monta acá y en ningún otro lado. */}
