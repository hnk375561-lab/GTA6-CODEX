    ...
    >
      ...
      >
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full text-ink transition-colors hover:bg-surface-alt hover:text-auto-accent-strong disabled:pointer-events-none disabled:opacity-35"
        >
        ...
        {isZoomed && (
          <>
            ...
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full text-ink transition-colors hover:bg-surface-alt hover:text-auto-accent-strong"
            >
