    ...
    <div className="rounded-lg border border-auto-accent/40 bg-auto-accent/5 p-4">
      ...
      {href && (
        <a
          ...
          onClick={handleClick}
          className="tap-scale inline-flex items-center justify-center rounded-lg bg-auto-accent px-4 py-2 text-sm font-semibold text-white transition-transform hover:scale-105"
        >
