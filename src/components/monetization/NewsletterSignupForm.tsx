    ...
    <div className={className}>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-lg bg-auto-accent px-4 py-2 text-sm font-semibold text-auto-darker transition-transform hover:scale-105 disabled:cursor-not-allowed disabled:opacity-50"
        >
          Sumarme
        </button>
      </form>
