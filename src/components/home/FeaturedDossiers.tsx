          ...
          {featured.map((vehicle, index) => {
            ...
            return (
              <Link
                ...
                prefetch={false}
                className="lift-on-hover group/dossier relative bg-surface-card border border-border overflow-hidden hover:border-oxide-red/50 transition-colors duration-200"
                style={{
