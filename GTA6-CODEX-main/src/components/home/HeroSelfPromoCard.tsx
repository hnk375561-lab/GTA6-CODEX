      ...
      <div className="flex flex-1 flex-col gap-2.5 p-2.5">
        {items.map((item) => (
          <Link
            ...
            className="hero-card-hover tap-scale group relative flex flex-1 items-stretch gap-3 overflow-hidden rounded-2xl bg-white/5 ring-1 ring-white/10 transition-colors duration-150 hover:bg-white/10 hover:ring-white/25 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-auto-accent"
          >
