...
También se encontró y corrigió (agosto 2026) un problema de integridad
de datos en 71 de las 250 fichas: campos de motor/transmisión/tanque
"de relleno" tipo combustión aplicados por error a vehículos eléctricos
e híbridos (un Tesla o un BYD mostraban `tipoMotor: "Gasolina/Diésel"`),
más transmisiones de moto sin diferenciar manual/automática y una
cadena corrupta en una ficha. Detalle completo, regla por regla, en
[`docs/audit-powertrain-integrity-2026-08.md`](./docs/audit-powertrain-integrity-2026-08.md);
